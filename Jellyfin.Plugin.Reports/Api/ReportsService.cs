...
namespace Jellyfin.Plugin.Reports.Api
{
    ...
    public class ReportsService
    {
        ...
        public ReportsService(IUserManager userManager, ILibraryManager libraryManager, ILocalizationManager localization, IActivityManager activityManager, IUserDataManager userDataManager)
        {
        ...
        /// <summary> Manager for user data. </summary>
        ...
        public object Get(GetReportHeaders request)
        {
            ...
            {
                ReportViewType.ReportData => new ReportBuilder(_libraryManager, _userDataManager).GetHeaders(request),
        ...
        private ReportResult GetReportResult(BaseReportRequest request)
        {
            ...
            ReportBuilder reportBuilder = new ReportBuilder(_libraryManager, _userDataManager);
